...
def main():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        anki = Anki.create_deck(deckname, audio_dir, category=category)
        polly = Polly.create_from_env(audio_dir)
        ...
        for i, card in enumerate(tqdm(deck)):
            ...
            anki.add_note(french_text, english_text, audio_basename)
            anki.add_note(english_text, french_text, audio_basename)
